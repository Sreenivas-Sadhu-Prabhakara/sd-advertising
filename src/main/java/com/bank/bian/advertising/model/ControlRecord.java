package com.bank.bian.advertising.model;
...
/**
 * The BIAN control record for this service domain: "Advertising Campaign Operating Session".
 *
 ...
 * to its asset type (Advertising Campaign). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Advertising Campaign Operating Session";
